...
/*  Conversion of CMNDF Metrics for Clarity
  ...
  /*  a condition to check for a significant amount of "silence frames",
    ...
    smoothCents += (info.cents - smoothCents) * 0.35;  // this is done to prevent the needle from wildly jumping around 
...
/*  Complete Audio Signal Chain w/ Spectral Pre-Filter
  ...
  async function start() {
    ...
    try {
      ...
      analyzer.fftSize = 4096;    // assigning analysis frame size
